package com.carding.mainstay.sys.common.util;
...
/**
 * 常用正则表达式。
 * 1. 电话号码 2. 邮编 3. QQ 4. E-mail 5. 手机号码 6. URL 7. 是否为数字
 * 8. 是否为中文 9. 身份证 10. 域名 11. IP
 *
 * @author duanjw
 */
public class RegexUtils {
    ...
    public static boolean isWechat(String wechat) {
        ...
        return Pattern.matches(regex, wechat);
    }
    ...
    /**
     * 匹配空格(前后有空格) 推荐使用：str.replace(string, '');
     *
     * @param string 字符串
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    /**
     * 匹配数字与英文字母字符串(由数字和26个英文字母组成的字符串)
     *
     * @param string 字符串
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    public static boolean isSql(String sql) {
        String regex = "^(select|drop|delete|create|update|insert).*$";
